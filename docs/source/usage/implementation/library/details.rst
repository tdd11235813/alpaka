...
For usage in current C++ there are libraries like `Boost.ConceptCheck <http://www.boost.org/doc/libs/1_58_0/libs/concept_check/concept_check.htm>`_ which try to emulate requirement checking of concept types.
