...
cmake -G "Unix Makefiles" \
    ...
    "$(env2cmake ALPAKA_ACC_HIP_ENABLE)" "$(env2cmake ALPAKA_CI_HIP_ROOT_DIR)" "$(env2cmake ALPAKA_CI_HIP_BRANCH)" "$(env2cmake ALPAKA_HIP_ARCH)" "$(env2cmake ALPAKA_HIP_PLATFORM)" \
